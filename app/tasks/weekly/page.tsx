...
const initialTasks: Task[] = [
  { id: 1, title: "Review PSX portfolio performance", description: "Check weekly gains/losses and rebalance if needed", completed: false, priority: "high", dueDate: "2024-01-21" },
  { id: 2, title: "Update crypto price alerts", description: "Set new price alerts for BTC and ETH", completed: false, priority: "medium", dueDate: "2024-01-22" },
  { id: 3, title: "Research new stock opportunities", description: "Look into banking sector stocks", completed: false, priority: "low", dueDate: "2024-01-23" },
]
        ...
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">Track your weekly investment tasks</p>
            </div>
            <button
          ...
          <div className="space-y-3">
            {tasks.map((task) => (
              <div
                key={task.id}
                className={`bg-card border border-border rounded-xl p-4 flex items-start gap-4 hover:border-primary/50 transition-colors ${
