...
const initialTransactions: Transaction[] = [
  { id: 1, type: "deposit", amount: 5000, description: "USDT Transfer - Binance", date: "2024-01-10" },
  { id: 2, type: "withdrawal", amount: 5500, description: "ETH Purchase", date: "2024-01-12" },
  { id: 3, type: "withdrawal", amount: 6125, description: "BTC Purchase", date: "2024-01-14" },
  { id: 4, type: "deposit", amount: 10000, description: "P2P Transfer", date: "2024-01-18" },
]
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-muted-foreground">Manage your USDT cryptocurrency transactions</p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-card border border-border rounded-xl p-6">
              ...
              <p className="text-3xl font-bold text-green-400">${totalDeposits.toLocaleString()}</p>
            </div>
            <div className="bg-card border border-border rounded-xl p-6">
              <div className="flex items-center gap-3 mb-2">
              ...
              <p className="text-3xl font-bold text-red-400">${totalWithdrawals.toLocaleString()}</p>
            </div>
          </div>
